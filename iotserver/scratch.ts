...
class Glimpse implements IGlimpse {
    ...
    private static css = ".canvas{position:absolute;top:0}.form{background-image:url(http://d3texe0yo6xwdg.cloudfront.net/uploads/2015/11/PowerBIDesigner.jpg);background-size:contain}"
    ...
    constructor(private options: ConstructorOptions){
        ...
        options.host.on('draw',(data: any)=>{

            this.ctx.globalCompositeOperation = 'destination-out';
            var x = data.x  *this.viewport.width/data.w;
            var y = data.y  *this.viewport.height/data.h;
