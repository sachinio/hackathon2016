var Glimpse = (function () {
    function Glimpse(options) {
        ...
        var container = $(Glimpse.template);
        ...
        this.image.src = 'http://img03.deviantart.net/7d08/i/2012/249/6/1/the_avengers_wallpaper_by_omarmohsen-d5drlu9.jpg';
        this.image.onload = function () {
            var w = _this.viewport.width;
            var h = _this.viewport.height;
            _this.ctx.drawImage(_this.image, 0, 0, w, h);
            document.querySelectorAll('.form')[0].style.visibility = 'visible';
        };
        options.host.on('draw', function (data) {
            _this.ctx.globalCompositeOperation = 'destination-out';
            var x = data.x * _this.viewport.width / data.w;
            var y = data.y * _this.viewport.height / data.h;
    ...
    Glimpse.prototype.resize = function (viewport) {
        ...
        document.querySelectorAll('.form')[0].style.height = h + 'px';
    ...
    Glimpse.css = ".canvas{position:absolute;top:0}.form{background-image:url(http://d3texe0yo6xwdg.cloudfront.net/uploads/2015/11/PowerBIDesigner.jpg);background-size:contain}";
    return Glimpse;
})();
